...
module.exports = async (client: { channels: { fetch: (arg0: string) => any; }; guilds: { cache: { size: any; }; }; }) => {
    ...
    const users = await client.channels.fetch('903626444729647114');
    ...
    // users.setName(`Serving ${idontrememberthetexttoputhere} Users`)
